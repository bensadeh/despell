...
func GetDefaults() map[string]core.Icon {
	return map[string]core.Icon{
		...
		"node":       {Icon: nerdfont.Node, Color: colors.Green, Emoji: emoji.Globe},
		"npm":        {Icon: nerdfont.Package, Color: colors.Red, Emoji: emoji.Package},
		"nvim":       {Icon: nerdfont.Vi, Color: colors.Green, Emoji: emoji.Pen},
		...
		"vi":         {Icon: nerdfont.Vi, Color: colors.Green, Emoji: emoji.Pen},
		"vim":        {Icon: nerdfont.Vi, Color: colors.Green, Emoji: emoji.Pen},
